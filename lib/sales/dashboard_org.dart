                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('Date: '+DateFormat.yMMMEd().format(DateTime.now()),
                            style: GoogleFonts.openSans(
                              fontSize: 15,
                              color: Colors.black,
                            ),
                          ...
                          SizedBox(width: 50,),
                          Text('Time: '+DateFormat.j().format(DateTime.now()),
                            style: GoogleFonts.openSans(
                              fontSize: 15,
                              color: Colors.black,
                            ),
                      ...
                      Center(
                        child: Text("Today's Shop Target",
                          style: GoogleFonts.openSans(
                              fontSize: 15,
                              color: Colors.black,
                              fontWeight: FontWeight.bold
...
//                      width: MediaQuery.of(context).size.width/3.5,
                      ...
                      Center(
                        child: Text("Monthly Sale Target",
                          style: GoogleFonts.openSans(
                              fontSize: 15,
                              color: Colors.black,
                              fontWeight: FontWeight.bold
