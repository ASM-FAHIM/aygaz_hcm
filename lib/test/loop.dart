...
class _LooptryState extends State<Looptry> {
  ...
  //
  //
  //   var response= await http.post(Uri.parse('http://172.20.20.69/monyeem/loginapi.php'),body:
                      ...
                      child: FlatButton(
                        ...
                        onPressed: ()async{
                          ...
                          if(dt2.isBefore(dt1)){
                            ...
                            var response= await http.post(Uri.parse('http://172.20.20.69/monyeem/leaveandtourapply.php'),body:
                            jsonEncode(<String, String>{
                              "zid" : "100060",
                              ...
                              return  AlertDialog(
                                ...
                                content:  Column(
                                  children: [
                                    ...
                                    Text("From Date: " + _value,
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    ),
                                    Text("To Date: " + _value1,
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    ),
                                  ...
                                  FlatButton(
                                    ...
                                    onPressed: ()async{
                                      ...
                                      for(i = 1 ;i<= difference ; i++){
                                        var response= await http.post(Uri.parse('http://172.20.20.69/monyeem/attandence_report.php'),body:
                                        jsonEncode(<String, String>{
