...
class _Admin_Late_Leave_NotificationListState
  ...
  Future<List<LateNotiModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse('http://172.20.20.69/api/adminnotification/lateemployee.php'),
                                ...
                                children: [
                                  FlatButton(
                                    ...
                                    onPressed: () async {
                                      var response = await http.post(
                                          Uri.parse(
                                              'http://172.20.20.69/api/adminapprove/lateapprove.php'),
                                          body: jsonEncode(<String, String>{
                                            "zid": "100060",
                                            "user": widget.zemail,
                                            "xposition": widget.xposition,
                                              ...
                                              actions: [
                                                FlatButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    var response = await http.post(
                                                        Uri.parse(
                                                            'http://172.20.20.69/api/adminapprove/latereject.php'),
                                                        body: jsonEncode(<
                                                            String, String>{
                                                          "zid": "100060",
                                                          "user": widget.zemail,
