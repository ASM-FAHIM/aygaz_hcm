...
class _Pending_voucherState extends State<Pending_voucher> {
  ...
  Future<List<PendingvoucherModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse('http://a.b.c.d/aygaz/notifications/pendingvoucher.php'),
                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                            ...
                            children: <Widget>[
                              ...
                              //         var response = await http.post(
                              //             Uri.parse(
                              //                 'http://a.b.c.d/aygaz/notifications/pendingVoucherapproval.php'),
                              //             body: jsonEncode(<String, String>{
                              //               "zid": widget.zid,
                              //               "user": widget.zemail,
                              //               "xposition": widget.xposition,
                              ...
                              //                       var response = await http.post(
                              //                           Uri.parse(
                              //                               'http://a.b.c.d/aygaz/notifications/pendingVoucherreject.php'),
                              //                           body: jsonEncode(<
                              //                               String, String>{
                              //                             "zid": widget.zid,
                              //                             "user": widget.zemail,
