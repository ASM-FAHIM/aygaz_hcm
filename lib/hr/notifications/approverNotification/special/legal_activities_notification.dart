...
class Legal_activities_Notification extends StatefulWidget {
  ...
  Legal_activities_Notification({required this.xposition, required this.xstaff, required this.zemail, required this.zid});
  String xposition;
  String xstaff;
  String zemail;
  String zid;
  ...
  @override
  _Legal_activities_NotificationState createState() => _Legal_activities_NotificationState();
}

class _Legal_activities_NotificationState extends State<Legal_activities_Notification> {
  ...
  Future<List<LegalActivitiesNotiModel>> fetchPost() async {
    var response= await http.post(Uri.parse('http://172.20.20.69/api/adminnotification/legalactive.php'),body:
    ...
    if (response.statusCode == 200) {
      ...
      return parsed.map<LegalActivitiesNotiModel>((json) => LegalActivitiesNotiModel.fromJson(json)).toList();
    } else {
                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(" ${snapshot.data![index].reqnum}",
                            ...
                            children: <Widget>[
                              ...
                              Text("Requisition No : "+"${snapshot.data![index].reqnum}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              //   ),
                              // ),
                              Text("Payee Company: "+"${snapshot.data![index].xcompany}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Justification: "+"${snapshot.data![index].xnote}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Total Amount: "+"${snapshot.data![index].amount}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                                ...
                                children: [
                                  FlatButton(
                                    ...
                                    onPressed: ()async{
                                      ...
                                      var response= await http.post(Uri.parse('http://172.20.20.69/api/adminapprove/legalactivereject.php'),body:
                                      jsonEncode(<String, String>{
                                        "zid": widget.zid,
                                        "user": widget.zemail,
                                        "xposition": widget.xposition,
                                        "xacreqnum": snapshot.data![index].reqnum.toString(),
                                        "ypd":"0",
