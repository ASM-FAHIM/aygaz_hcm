...
class Advance_Money_requi_Notification extends StatefulWidget {
  ...
  Advance_Money_requi_Notification({required this.xposition, required this.xstaff, required this.zemail, required this.zid});
  String xposition;
  String xstaff;
  String zemail;
  String zid;
  ...
  @override
  _Advance_Money_requi_NotificationState createState() => _Advance_Money_requi_NotificationState();
}

class _Advance_Money_requi_NotificationState extends State<Advance_Money_requi_Notification> {
  ...
  Future<List<AdvanceMoneyRequNotiModel>> fetchPost() async {
    var response= await http.post(Uri.parse('http://172.20.20.69/api/adminnotification/neptune/othermoney.php'),body:
    ...
    if (response.statusCode == 200) {
      ...
      return parsed.map<AdvanceMoneyRequNotiModel>((json) => AdvanceMoneyRequNotiModel.fromJson(json)).toList();
    } else {
                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                            ...
                            children: <Widget>[
                              ...
                              Text("Purpose of advance: "+"${snapshot.data![index].xnote}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Advance Approval Status: "+"${snapshot.data![index].xstatus}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                                ...
                                children: [
                                  FlatButton(
                                    ...
                                    onPressed: ()async{
                                      ...
                                      var response= await http.post(Uri.parse('http://172.20.20.69/api/adminapprove/othermoneyapprove.php'),body:
                                      jsonEncode(<String, String>{
                                        "zid": widget.zid,
                                        "user": widget.zemail,
                                      ...
                                      print("Approve"+snapshot.data![index].acreqnum.toString());
                                    },
                                    child: Text("Approve"),
                                  ),
                                  SizedBox(width: 50,),
                                          ...
                                          actions: [
                                            FlatButton(
                                              ...
                                              onPressed: ()async{
                                                ...
                                                var response= await http.post(Uri.parse('http://172.20.20.69/api/adminnotification/neptune/othermoneyreject.php'),body:
                                                jsonEncode(<String, String>{
                                                  "zid": widget.zid,
                                                  "user": widget.zemail,
                                                  "xposition": widget.xposition,
