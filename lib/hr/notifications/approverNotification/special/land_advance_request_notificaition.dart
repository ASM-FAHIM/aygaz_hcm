...
class Advance_request_NOtification extends StatefulWidget {
  ...
  Advance_request_NOtification({required this.xposition, required this.xstaff, required this.zemail, required this.zid});
  String xposition;
  String xstaff;
  String zemail;
  String zid;
  ...
  @override
  _Advance_request_NOtificationState createState() => _Advance_request_NOtificationState();
}

class _Advance_request_NOtificationState extends State<Advance_request_NOtification> {
  ...
  Future<List<LandAdvanceNotiModel>> fetchPost() async {
    var response= await http.post(Uri.parse('http://172.20.20.69/api/adminnotification/neptune/landadvance.php'),body:
    ...
    if (response.statusCode == 200) {
      ...
      return parsed.map<LandAdvanceNotiModel>((json) => LandAdvanceNotiModel.fromJson(json)).toList();
    } else {
                        ...
                        child: Padding(
                          ...
                          child: ExpansionTile(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(" ${snapshot.data![index].acreqnum}",
                            ...
                            children: <Widget>[
                              ...
                              Text("Advance Number : "+"${snapshot.data![index].acreqnum}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              //   ),
                              // ),
                              Text("PO Number : "+"${snapshot.data![index].xpornum}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Seller Name : "+"${snapshot.data![index].sellername}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Project Name : "+"${snapshot.data![index].projectname}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Advance Amount: "+"${snapshot.data![index].xprime}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Purpose: "+"${snapshot.data![index].xnote}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Status: "+"${snapshot.data![index].xstatus}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                                ...
                                children: [
                                  FlatButton(
                                    ...
                                    onPressed: ()async{
                                      ...
                                      var response= await http.post(Uri.parse('http://172.20.20.69/api/adminapprove/landadvapprove.php'),body:
                                      jsonEncode(<String, String>{
                                        "zid": widget.zid,
                                        "user": widget.zemail,
                                        "xposition": widget.xposition,
                                        "xacreqnum": snapshot.data![index].acreqnum.toString(),
                                        "ypd":"0",
                                          ...
                                          actions: [
                                            FlatButton(
                                              ...
                                              onPressed: ()async{
                                                ...
                                                var response= await http.post(Uri.parse('http://172.20.20.69/api/adminapprove/landadvreject.php'),body:
                                                jsonEncode(<String, String>{
                                                  "zid": widget.zid,
                                                  "user": widget.zemail,
                                                  "xposition": widget.xposition,
                                                ...
                                                print("Reject"+snapshot.data![index].acreqnum.toString());
                                                Navigator.pop(context);
