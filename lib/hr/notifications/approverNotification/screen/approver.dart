...
import 'package:aygazhcm/hr/notifications/approverNotification/screen/approver_category.dart';
...
class AdminNotification extends StatefulWidget {
  ...
  AdminNotification({required this.xposition, required this.xstaff, required this.zemail, required this.zid});
  String xposition;
  String xstaff;
  String zemail;
  String zid;
...
class _AdminNotificationState extends State<AdminNotification> {
  ...
  Future<String>  getAdminNotificaitonCount() async {
    ...
    http.Response responseearly = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalearly.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition
        })
    );
    ...
    http.Response responselate = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totallate.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition
        })
    );
    ...
    http.Response responseleave = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalleaveandtour.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition
        })
    );
    ...
    http.Response responseabsent = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalabsent.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition
        })
    );
    ...
    http.Response responsePO = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalpo.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition,
          "zid" : widget.zid
        })
    ...
    http.Response responseSR= await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalsr.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition,
          "zid" : widget.zid
        })
    ...
    http.Response responseCS = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/totalcs.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition,
          "zid" : widget.zid
        })
    ...
    http.Response responseLA = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/count_legalactive.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition,
          "zid" : widget.zid
        })
    ...
    http.Response responseLFA = await http.post(Uri.parse('http://172.20.20.69/api/smallapi/admin/count_legaladjust.php'),
        body:jsonEncode(<String, String>{
          "xposition" : widget.xposition,
          "zid" : widget.zid
        })
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Future.delayed(Duration(seconds: 1), () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminNotificationList(xposition: widget.xposition,xstaff: widget.xstaff,zemail: widget.zemail,zid: widget.zid,adminabsent: absentCount,adminearly: earlyCount,adminlate: lateCount,adminPO: POCount,adminSR: SRCount,adminCS: CSCount,adminLeave: leaveCount,adminLA: LACount,adminLFA: LFACount,)));
                        });
              ...
              //         //   ),
              //         // ));
              //         Navigator.push(context, MaterialPageRoute(builder: (context)=>Admin_Early_Leave_NotificationList(xposition: widget.xposition,xstaff: widget.xstaff,)));
              //       },
              //       child: Column(
              //         crossAxisAlignment: CrossAxisAlignment.center,
              //         mainAxisAlignment: MainAxisAlignment.center,
              //         children: [
              //           Text(
              //             "Admin Early Leave Information Details",
              //             textAlign: TextAlign.center,
              //             style: GoogleFonts.bakbakOne(
              //               fontSize: 18,
              //               color: Color(0xff064A76),
