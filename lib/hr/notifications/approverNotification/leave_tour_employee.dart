...
class Admin_Leave_Tour_NotificationList extends StatefulWidget {
  ...
  Admin_Leave_Tour_NotificationList({required this.xposition, required this.xstaff});
  String xposition;
  String xstaff;

  @override
  _Admin_Leave_Tour_NotificationListState createState() => _Admin_Leave_Tour_NotificationListState();
}

class _Admin_Leave_Tour_NotificationListState extends State<Admin_Leave_Tour_NotificationList> {
  // fetchnotification _noteList = fetchnotification();
  //fetchnotification _noteList = fetchnotification();
  ...
  Future<List<LeaveandTourempNotiModel>> fetchPost() async {
    var response= await http.post(Uri.parse('http://172.20.20.69/api/adminnotification/leaveandtouradmin.php'),body:
    jsonEncode(<String, String>{
      "xposition": widget.xposition,
    })
    );
    ...
    if (response.statusCode == 200) {
      ...
      return parsed.map<LeaveandTourempNotiModel>((json) => LeaveandTourempNotiModel.fromJson(json)).toList();
    } else {
      throw Exception('Failed to load album');
    }
  }
                      ...
                      Card(
                        child: Padding(
                          ...
                          child: ExpansionTile(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(" ${snapshot.data![index].xname}",
                            ...
                            children: <Widget>[
                              Text("From Date : "+(DateFormat("dd-MM-yyyy").format(DateTime.parse((snapshot.data![index].xdatefrom.date).toString()))).toString(),
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              //   ),
                              // ),
                              Text("To Time : "+(DateFormat("dd-MM-yyyy").format(DateTime.parse((snapshot.data![index].xdateto.date).toString()))).toString(),
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ...
                              Text("Leave Type: "+"${snapshot.data![index].xtypeleave.toString()}",
                                textAlign: TextAlign.center,
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                              ...
                              Text("Applied Date : "+"${snapshot.data![index].xappday.toString()}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ),
                              Text("Approved Day : "+"${snapshot.data![index].xday.toString()}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                              ),
                              Text("Note : "+"${snapshot.data![index].xnote.toString()}",
                                style: GoogleFonts.bakbakOne(
                                  fontSize: 18,
                                  //color: Color(0xff074974),
                                ),
                                ...
                                children: [
                                  FlatButton(
                                    ...
                                    onPressed: ()async{
                                      ...
                                      var response= await http.post(Uri.parse('http://172.20.20.69/api/adminapprove/leaveandtourapprove.php'),body:
                                      jsonEncode(<String, String>{
                                        "zid":"100060",
                                        ...
                                        "xnote":"kjdfg",
                                        "xtypeleave":snapshot.data![index].xtypeleave,
                                        "xdatefrom":snapshot.data![index].xdatefrom.toString(),
                                        "xdateto":snapshot.data![index].xdateto.toString(),
                                        "xstatus":snapshot.data![index].xstatus,
                                        "xday": snapshot.data![index].xday,
                                        "xyear": snapshot.data![index].xyear.toString()
                                      })
                                      );
                                            ...
                                            FlatButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                var response = await http.post(Uri.parse(
                                                    'http://172.20.20.69/api/adminapprove/leaveandtourreject.php'), body:
                                                jsonEncode(<String, String>{
                                                  "zid":"100060",
                                                  "user": widget.xposition,
                                                  "xposition": widget.xposition,
