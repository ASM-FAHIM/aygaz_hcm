...
class _PSRA_notificationState extends State<PSRA_notification> {
  ...
  Future<List<SoModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse('http://a.b.c.d/aygaz/notifications/PendingSalesReturn.php'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
          ...
          //                               var response = await http.post(
          //                                   Uri.parse(
          //                                       'http://a.b.c.d/aygaz/notifications/PendingSalesReturnApprove.php'),
          //                                   body: jsonEncode(<String, String>{
          //                                     "zid": widget.zid,
          //                                     "user": widget.zemail,
          //                                     "xposition": widget.xposition,
          ...
          //                                             var response = await http.post(
          //                                                 Uri.parse(
          //                                                     'http://a.b.c.d/aygaz/notifications/PendingSalesReturnReject.php'),
          //                                                 body: jsonEncode(<
          //                                                     String, String>{
          //                                                   "zid": widget.zid,
          //                                                   "user": widget.zemail,
