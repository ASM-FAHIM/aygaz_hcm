...
//     print("called");
//     var response= await http.post(Uri.parse('http://a.b.c.d/api/payslip/payment.php'),body:
...
//     print("called");
//     var response= await http.post(Uri.parse('http://a.b.c.d/api/payslip/deduct.php'),body:
//     jsonEncode(<String, String>{
//       "xstaff":widget.xstaff,
//       "xyear": dropdownvalue2,
//       "xper": dropdownvalue
...
//   //
//   //   http.Response response = await http.post(Uri.parse('http://a.b.c.d/api/payslip/totalpay.php'),
...
//     print("called");
//     var response= await http.post(Uri.parse('http://a.b.c.d/api/payslip/totalpay.php'),body:
//     jsonEncode(<String, String>{
//       "xstaff":widget.xstaff,
//       "xyear": dropdownvalue2,
//       "xper": dropdownvalue
...
class _Payslip_pageState extends State<Payslip_page> {
  ...
  //       Uri.parse('http://a.b.c.d/api/payslip/payment.php'),
  //       body: jsonEncode(<String, String>{
  //         "xstaff": widget.xstaff,
  //         "xyear": dropdownvalue2,
  //         "xper": dropdownvalue
  ...
  //   print("called");
  //   var response = await http.post(
  //       Uri.parse('http://a.b.c.d/api/payslip/deduct.php'),
  //       body: jsonEncode(<String, String>{
  //         "xstaff": widget.xstaff,
  //         "xyear": dropdownvalue2,
  //         "xper": dropdownvalue
  ...
  //   print("called");
  //   var response = await http.post(
  //       Uri.parse('http://a.b.c.d/api/payslip/totalpay.php'),
  //       body: jsonEncode(<String, String>{
  //         "xstaff": widget.xstaff,
  //         "xyear": dropdownvalue2,
  //         "xper": dropdownvalue
